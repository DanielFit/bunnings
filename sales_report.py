...
beat it by 10% discount was brought in and what the prices were."""
...
power_tool_sales_growth = analysis.profit_loss_by_year_category_total(power_tools_profits_fy1, power_tools_profits_fy2)
outdoor_furniture_sales_growth = analysis.profit_loss_by_year_category_total(outdoor_furniture_profits_fy1, outdoor_furniture_profits_fy2)
timber_sales_growth = analysis.profit_loss_by_year_category_total(timber_profits_fy1, timber_profits_fy2)
